...
info_def  = MB_def_config();
plotpause = 1;         

try info.appCmet;       catch, info.appCmet   = info_def.appCmet;    end
try info.vicTp;         catch, info.vicTp     = info_def.vicTp;      end
try info.vincYp;        catch, info.vincYp    = info_def.vincYp;     end
try info.PPf0;          catch, info.PPf0      = info_def.PPf0;       end
try info.extraMet;      catch, info.extraMet  = info_def.extraMet;   end
try info.vinct1;        catch, info.vinct1    = info_def.vinct1;     end
try info.CmetEst;       catch, info.CmetEst   = info_def.CmetEst;    end
try info.CmetModel;     catch, info.CmetModel = info_def.CmetModel;  end
